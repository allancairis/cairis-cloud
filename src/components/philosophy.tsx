  ...
  return (
    <section className="relative overflow-hidden border-y border-white/10 bg-[#070b11] py-24 md:py-32" aria-labelledby="filosofia-title">
      ...
      <div className="section-shell relative">
        <Reveal className="max-w-4xl"><p className="section-kicker">Filosofia profissional</p><h2 id="filosofia-title" className="heading-lg text-balance">Eu acredito que engenharia excelente torna o complexo operável.</h2></Reveal>
        <Reveal delay={0.06} className="glass mt-10 overflow-hidden rounded-lg"><Image src="/assets/devsecops-platform.svg" alt="Visual abstrato de plataforma segura, DevSecOps e observabilidade" width={960} height={720} className="max-h-[420px] w-full object-cover" /></Reveal>
