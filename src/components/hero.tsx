    ...
    <section id="topo" className="relative isolate min-h-screen overflow-hidden pt-28" aria-labelledby="hero-title">
      ...
      <div className="section-shell grid min-h-[calc(100vh-7rem)] items-center gap-12 pb-14 lg:grid-cols-[minmax(0,1.08fr)_minmax(360px,.74fr)]">
        <div className="max-w-4xl">
          <motion.p className="section-kicker" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            Arquitetura executiva | DevSecOps | IA aplicada
          </motion.p>
          <motion.h1 id="hero-title" className="heading-xl max-w-5xl text-balance" initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.08 }}>
          ...
          <motion.div className="mt-9 flex flex-wrap gap-3" initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.24 }} aria-label="Acoes principais">
            ...
            <a href="https://www.linkedin.com/in/allancairis/" className="focus-ring inline-flex min-h-12 items-center gap-2 rounded-md border border-white/12 bg-white/8 px-5 py-3 text-sm font-bold text-white transition hover:border-cyan/50 hover:bg-cyan/10">
              <Linkedin className="h-4 w-4" aria-hidden="true" />
              LinkedIn
            </a>
            <a href="https://github.com/allancairis" className="focus-ring inline-flex min-h-12 items-center gap-2 rounded-md border border-white/12 bg-white/8 px-5 py-3 text-sm font-bold text-white transition hover:border-cyan/50 hover:bg-cyan/10">
          ...
          <motion.dl className="mt-12 grid max-w-3xl gap-3 sm:grid-cols-3" initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.32 }}>
            {stats.map((stat) => (
              <div key={stat.label} className="glass rounded-lg p-4">
                <dt className="text-xs uppercase text-muted">{stat.label}</dt>
        ...
        <motion.aside className="glass relative overflow-hidden rounded-lg p-5" initial={{ opacity: 0, x: 34 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, delay: 0.18 }} aria-label="Painel executivo">
          ...
          <div className="relative mt-5 rounded-lg border border-white/10 bg-[#05080d]/86 p-4 font-mono text-xs text-cyan/90">
          ...
          <a href="mailto:allan@cairis.cloud" className="focus-ring relative mt-5 inline-flex w-full items-center justify-center gap-2 rounded-md border border-white/12 bg-white/8 px-4 py-3 text-sm font-bold text-white transition hover:border-cyan/50 hover:bg-cyan/10">
